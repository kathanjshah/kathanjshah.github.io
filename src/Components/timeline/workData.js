...
export const jobs = [
    ...
    },
    {
      ...
      place: "St. John's, NL",
      description: ["Coordinated membership events, including banquets, concerts, and conferences, while providing administrative support to Development Directors. Created and maintained a Slack network for internal team communication and produced data science visualizations using Python libraries like Pandas and Seaborn."]
    },
    {
